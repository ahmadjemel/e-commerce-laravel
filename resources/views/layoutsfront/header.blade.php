                    ...
                    <div class="main-menu">
                        <nav>
                            <ul>
                                ...
                                <li><a href="shop.html"> Produits <i class="fa fa-angle-down"></i> </a>
                                    <ul class="mega-menu">
                                        <li>
                                            <ul>
                                               @foreach ($categories as $category)

                                                <li><a href="{{route('front.products',$category->id)}}">{{$category->name}}</a></li><!--condition de choit $category->id au niveau du route-->
                                                @endforeach
                                             </ul>
                                        </li>
                       ...
                       <div class="header-right-wrap">
                        ...
                        <div class="same-style cart-wrap">
                            <button class="icon-cart">
                                ...
                                <span class="count-style">{{count(session()->get('panier'))}}</span>
                            </button>
                                    ...
                                    @endphp
                                     <li class="single-shopping-cart">
                                        <div class="shopping-cart-img">
                                            <a href="#"><img alt="" src="{{asset('images/products'.$product['photo'])}}" width="50"></a>
                                        </div>
                ...
                <div class="mobile-menu">
                    <nav id="mobile-menu-active">
                        <ul class="menu-overflow">
                            ...
                            <li><a href="blog.html">produits</a>
                                <ul>
                                    <li><a href="blog.html">blog standard</a></li>
                                    <li><a href="blog-no-sidebar.html">blog no sidebar</a></li>
                                    <li><a href="blog-right-sidebar.html">blog right sidebar</a></li>

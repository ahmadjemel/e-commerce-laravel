        ...
        <div class="custom-row">
                ...
                <div class="product-wrap-2 mb-25 scroll-zoom">
                    <div class="product-img">
                        <a href="product-details.html">
                            <img class="default-img" src="{{asset('img/product/hm3-pro-1.jpg')}}" alt="">
                            <img class="hover-img" src="{{asset('img/product/hm3-pro-1.jpg')}}" alt="">
                        </a>
                        <span class="pink">-10%</span>
                        <div class="product-action-2">
                            <a title="Add To Cart" onclick=" href='javascript:;'"><i class="fa fa-shopping-cart"></i></a>
            ...
            <div class="custom-col-5">
                <div class="product-wrap-2 mb-25 scroll-zoom">
                    <div class="product-img">
                        <a href="product-details.html">
                            <img class="default-img" src="{{asset('img/product/hm3-pro-3.jpg')}}" alt="">
                            <img class="hover-img" src="{{asset('img/product/hm3-pro-3.jpg')}}" alt="">
                        </a>
                        <span class="pink">-10%</span>
            ...
            <div class="custom-col-5">
                <div class="product-wrap-2 mb-25 scroll-zoom">
                    <div class="product-img">
                        <a href="product-details.html">
                            <img class="default-img" src="{{asset('img/product/hm3-pro-10.jpg')}}" alt="">
                            <img class="hover-img" src="{{asset('img/product/hm3-pro-10.jpg')}}" alt="">
                        </a>
